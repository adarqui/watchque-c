...
ret_t
parse_event_masks (char *s, int *m)
{
  RET_INIT;
 ...
 */
ret_t
parse_watch_single (blob_t * b, watch_citizen_t citizen, watch_t * wp,
		    ...
		    int recursive_onoff)
{
  ...
  _r = watch_init (citizen, wp, class, queue, events, source, filter,
		   mask, recursive_onoff);
  if (RET_ISOK != RET_BOOL_TRUE)
    {
...
ret_t
parse_watch_multi (blob_t * b, char *s)
{
