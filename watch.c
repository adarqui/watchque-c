...
ret_t
watch_cloneRef (watch_t * wp, char *source)
{
  watch_t *wc;
  RET_INIT;
...
ret_t
watch_init (watch_citizen_t citizen, watch_t * wp, char *class,
...
ret_t
watch_cb (blob_t * b, char *buf, int n)
{
...
ret_t
watch_delete (blob_t * b, watch_t * w)
{
  RET_INIT;
...
ret_t
watch_add_directory (blob_t * b, watch_t * w, char *path)
{
  RET_INIT;
